...
function preload()
{
  ...
  landing_padImg = loadImage("lz.png");
...
function setup() {
  ...
  landing_pad = createSprite(850,550,100,20);
  landing_pad.addImage('base',landing_padImg);
  landing_pad.scale = 0.5;
  //landing_pad.debug = true
  landing_pad.setCollider("rectangle",0,210,550,100)
